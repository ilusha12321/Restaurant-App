...
ActiveRecord::Schema[7.1].define(version: 2024_04_30_220001) do
  ...
  create_table "restaurants_lists", id: :integer, default: -> { "nextval('restaurants_list_id_seq'::regclass)" }, force: :cascade do |t|
  ...
  add_foreign_key "reviews", "restaurants_lists", column: "restaurant_id", name: "reviews_restaurant_id_fkey", validate: false
